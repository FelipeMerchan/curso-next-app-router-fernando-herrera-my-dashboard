...
si no usamos la función generateStaticParams la página será
considerada por Next como ServerSide Rendering por lo cual
no se crearán de forma estática las páginas: */
